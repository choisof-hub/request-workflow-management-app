...
物流実務で培った知識・経験とITの活用スキルを生かし、本社と倉庫の間で行うキャンセル連絡の仕組みを改善しました。

対象は、倉庫で商品を取りそろえた後に、顧客から本社へキャンセル依頼が入る業務です。従来のFAX運用では、連絡の見落としや情報共有の不足に加え、本社は「キャンセルできた」、倉庫は「出荷済みなので本社が返品手続きを進める」と考えるなど、認識の食い違いによって商品が返却されないことがありました。

そこで、Power Appsを用いた連絡アプリを作成しました。倉庫側の全員が依頼を確認でき、本社と倉庫で「返品待ち」「完了」などの対応状況やコメントを共有できるようにしました。依頼時・倉庫対応時のメール通知も組み合わせ、連絡の見落としや認識違いによる対応漏れを防ぐ仕組みを整えました。

本リポジトリでは、この業務改善の内容と設計上の工夫を紹介しています。機密情報に配慮し、実際の業務内容を公開用に再構成しています。
