...
物流実務で培った知識・経験とITの活用スキルを組み合わせ、紙・FAXを中心とした依頼業務を改善しました。私がPower Appsで作成したアプリにより、依頼内容と対応状況を一か所で確認できるようにし、作業時間の短縮、進捗の見える化、連絡漏れの削減を実現しました。

本リポジトリでは、その業務改善の成果と、現場の課題を仕組みで解決するために工夫した点を紹介しています。機密情報に配慮し、実際の業務内容を公開用に再構成しています。
