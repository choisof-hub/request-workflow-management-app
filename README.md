...
このリポジトリは、紙・FAXを中心とした物流関連の依頼業務をPower Appsで標準化し、受付から対応完了までの時間短縮と進捗の見える化、連絡漏れの改善などを実現した業務改善事例です。
私が実務で作成した業務改善アプリをもとに、依頼者と確認担当の間で発生する業務連絡を整理・標準化した公開用サンプルです。
